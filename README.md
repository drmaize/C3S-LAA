...
This shell script (consensus_calling.sh) will be generated by running "cluster.py". For users running this shell script as a torque submission, the standard qsub parameters are indicated at the beginning of this shell script, based on the user input parameters. This may be removed/modified if user decides to run this shell script locally.
